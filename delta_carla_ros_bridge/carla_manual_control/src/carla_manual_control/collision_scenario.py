...
class Colliding_Agent:
    ...
    def control_agent(self):
        ...
        if self.find_distance(self.vehicle.get_transform(), self.main_agent.get_transform()) < 35:
...
class Colliding_Agent:
    ...
    def control_agent(self):
        if (self.scene == 0) or (self.scene == 1) or (self.scene == 3) or (self.scene == 5):
        ...
        elif (self.scene == 2) or (self.scene == 4) :
            wait = 40
