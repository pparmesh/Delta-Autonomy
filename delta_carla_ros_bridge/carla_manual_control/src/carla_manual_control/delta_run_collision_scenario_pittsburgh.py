...
class KeyboardControl(object):
    def __init__(self, world, start_in_autopilot):
        ...
        self.image_subscriber = rospy.Subscriber("/delta/prediction/collision", CollisionDetection, self.collision_cb)
        self.collision_prob_threshold = rospy.get_param("collision_threshold", 0.5)
        self.collision = False

    def collision_cb(self, msg):
        if msg.probability > self.collision_prob_threshold:
            self.collision = True
        else:
            self.collision = False
